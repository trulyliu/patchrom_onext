...
.field public static final PARSE_IS_DATA_PRELOAD:I = 0x80

.field public static final PARSE_IS_DATA_PRELOAD_DIR:I = 0x100
...
.method public static generatePackageInfo(Landroid/content/pm/PackageParser$Package;[IIJJLjava/util/HashSet;ZII)Landroid/content/pm/PackageInfo;
    ...
    iget-object v15, v0, Landroid/content/pm/PackageParser$Package;->mHtcsdkVer:Ljava/lang/String;

    iput-object v15, v12, Landroid/content/pm/PackageInfo;->htcsdkVer:Ljava/lang/String;
...
.method private parseExtraPackageResPath(Landroid/content/pm/PackageParser$Package;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Ljava/util/ArrayList;)V
    .locals 3
    .parameter "pkg"
    .parameter "res"
    .parameter "parser"
    ...
    .prologue
    .line 1494
    .local p5, extraResPathList:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/String;>;"
    const/4 v1, 0x0
...
.method private parseHideApplicationAttribute(Landroid/content/pm/PackageParser$Package;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;)V
    .locals 3
    .parameter "pkg"
    .parameter "res"
    .parameter "parser"
    ...
    invoke-interface {p4, v0, v2}, Landroid/util/AttributeSet;->getAttributeBooleanValue(IZ)Z

    move-result v2

    iput-boolean v2, v1, Landroid/content/pm/ApplicationInfo;->isHideApk:Z
...
.method private parseHtcsdkAttribute(Landroid/content/pm/PackageParser$Package;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;)V
    .locals 3
    .parameter "pkg"
    .parameter "res"
    .parameter "parser"
    ...
    iput-object v2, p1, Landroid/content/pm/PackageParser$Package;->mHtcsdkVer:Ljava/lang/String;
...
.method private parsePackage(Landroid/content/res/Resources;Landroid/content/res/XmlResourceParser;I[Ljava/lang/String;)Landroid/content/pm/PackageParser$Package;
    ...
    .line 935
    const-string v39, "android.uid.felicalock"
    ...
    .line 938
    const-string v39, "android.uid.felica.testtool"
    ...
    .line 983
    .local v20, extraResPathList:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/String;>;"
    ...
    invoke-direct {v0, v4, v1, v2, v7}, Landroid/content/pm/PackageParser;->parseHtcsdkAttribute(Landroid/content/pm/PackageParser$Package;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;)V
    ...
    iput-boolean v5, v3, Landroid/content/pm/ApplicationInfo;->isHideApk:Z
    ...
    .line 1309
    :cond_38
    const-string v3, "HtcHideApplication"
    ...
    invoke-direct {v0, v4, v1, v2, v7}, Landroid/content/pm/PackageParser;->parseHideApplicationAttribute(Landroid/content/pm/PackageParser$Package;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;)V

    goto/16 :goto_1

    .line 1311
    :cond_39
    const-string v3, "HtcExtraPackageRes"
    ...
    .line 1312
    invoke-direct/range {v3 .. v8}, Landroid/content/pm/PackageParser;->parseExtraPackageResPath(Landroid/content/pm/PackageParser$Package;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Ljava/util/ArrayList;)V
    ...
    iput-object v3, v5, Landroid/content/pm/ApplicationInfo;->resourceDirs:[Ljava/lang/String;
...
.method private parseSkinAttribute(Landroid/content/pm/PackageParser$Package;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;)V
    ...
    .line 1477
    .local v0, attrName:Ljava/lang/String;
    const-string/jumbo v2, "skinVersion"
    ...
    iput v3, v2, Landroid/content/pm/ApplicationInfo;->skinVersion:I
