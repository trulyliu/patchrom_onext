...
.field private mWifiAggregation:Z
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iput-boolean v1, p0, Landroid/net/wifi/WifiStateMachine;->mWifiAggregation:Z

    .line 269
    const-string v1, "VerizonWiFi"

    iput-object v1, p0, Landroid/net/wifi/WifiStateMachine;->mVzwWifiString:Ljava/lang/String;
    ...
    iput v1, p0, Landroid/net/wifi/WifiStateMachine;->mUloghotspotMaxUsers:I

    .line 302
    const-wide/16 v1, -0x1

    iput-wide v1, p0, Landroid/net/wifi/WifiStateMachine;->mUlogHotspotDuration:J

    .line 303
    const-wide/16 v1, -0x1

    iput-wide v1, p0, Landroid/net/wifi/WifiStateMachine;->mUlogHotspotStartTime:J

    .line 317
    const/4 v1, 0x0

    iput-boolean v1, p0, Landroid/net/wifi/WifiStateMachine;->mWifiDisplayOn:Z
    ...
    iput v1, p0, Landroid/net/wifi/WifiStateMachine;->mReqSchedScanInteval:I

    .line 369
    const/4 v1, 0x0

    iput-boolean v1, p0, Landroid/net/wifi/WifiStateMachine;->mRoadmingDisabled:Z
    ...
    iput-boolean v1, p0, Landroid/net/wifi/WifiStateMachine;->mSetScanActive:Z

    .line 381
    const/4 v1, 0x0

    iput-boolean v1, p0, Landroid/net/wifi/WifiStateMachine;->mHighPerfMode:Z
    ...
    iput-boolean v1, p0, Landroid/net/wifi/WifiStateMachine;->mPowerSaveEnabled:Z
    ...
    iput-object v1, p0, Landroid/net/wifi/WifiStateMachine;->mConfigNoWps:Landroid/net/wifi/WifiConfiguration;
    ...
    invoke-direct {v1, p0}, Landroid/net/wifi/WifiStateMachine$13;-><init>(Landroid/net/wifi/WifiStateMachine;)V
    ...
    const-string v4, "com.htc.intent.action.CUSTOMIZATION_CHANGE"
    ...
    iput-object v1, p0, Landroid/net/wifi/WifiStateMachine;->mScreenFilter:Landroid/content/IntentFilter;

    .line 1204
    iget-object v1, p0, Landroid/net/wifi/WifiStateMachine;->mScreenFilter:Landroid/content/IntentFilter;
    ...
    invoke-direct {v1, p0}, Landroid/net/wifi/WifiStateMachine$5;-><init>(Landroid/net/wifi/WifiStateMachine;)V

    iput-object v1, p0, Landroid/net/wifi/WifiStateMachine;->mScreenReceiver:Landroid/content/BroadcastReceiver;
    ...
    const-string v4, "com.htc.wifi.PICK_VERIZON_WIFI_NETWORK"
    ...
    iput-object v1, p0, Landroid/net/wifi/WifiStateMachine;->mPerfWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    new-instance v2, Landroid/net/wifi/WifiStateMachine$9;

    invoke-direct {v2, p0}, Landroid/net/wifi/WifiStateMachine$9;-><init>(Landroid/net/wifi/WifiStateMachine;)V
    ...
    iput-object v1, p0, Landroid/net/wifi/WifiStateMachine;->mWDManager:Lcom/htc/service/WirelessDisplayManager;
    ...
    invoke-virtual {p0, v1}, Landroid/net/wifi/WifiStateMachine;->setProcessedMessagesSize(I)V
...
.method static synthetic access$10200(Landroid/net/wifi/WifiStateMachine;)Landroid/net/wifi/WifiConfiguration;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$10300(Landroid/net/wifi/WifiStateMachine;)Landroid/net/wifi/WifiConfiguration;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1100(Landroid/net/wifi/WifiStateMachine;)Landroid/net/wifi/WifiConfigStore;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$11802(Landroid/net/wifi/WifiStateMachine;I)I
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$1200(Landroid/net/wifi/WifiStateMachine;)Landroid/net/wifi/WifiNative;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$12000(Landroid/net/wifi/WifiStateMachine;Landroid/net/NetworkInfo$DetailedState;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$12100(Landroid/net/wifi/WifiStateMachine;)Z
    .locals 1
    .parameter "x0"
...
.method static synthetic access$12200(Landroid/net/wifi/WifiStateMachine;)Z
    .locals 1
    .parameter "x0"
...
.method static synthetic access$12800(Landroid/net/wifi/WifiStateMachine;)Landroid/content/BroadcastReceiver;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$12900(Landroid/net/wifi/WifiStateMachine;)Landroid/content/IntentFilter;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1300(Landroid/net/wifi/WifiStateMachine;)Lcom/htc/service/WirelessDisplayManager;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$13000(Landroid/net/wifi/WifiStateMachine;)Z
    .locals 1
    .parameter "x0"
...
.method static synthetic access$13500(Landroid/net/wifi/WifiStateMachine;)Lcom/android/internal/util/IState;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1500(Landroid/net/wifi/WifiStateMachine;Landroid/net/LinkProperties;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$16100(Landroid/net/wifi/WifiStateMachine;Ljava/lang/String;)[B
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$16200(Landroid/net/wifi/WifiStateMachine;)Landroid/os/PowerManager$WakeLock;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$16400(Landroid/net/wifi/WifiStateMachine;)Landroid/net/DhcpStateMachine;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$16402(Landroid/net/wifi/WifiStateMachine;Landroid/net/DhcpStateMachine;)Landroid/net/DhcpStateMachine;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$16500(Landroid/net/wifi/WifiStateMachine;Landroid/net/DhcpInfoInternal;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$17902(Landroid/net/wifi/WifiStateMachine;Z)Z
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$18000(Landroid/net/wifi/WifiStateMachine;)Z
    .locals 1
    .parameter "x0"
...
.method static synthetic access$18102(Landroid/net/wifi/WifiStateMachine;I)I
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$18200(Landroid/net/wifi/WifiStateMachine;I)I
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$18400(Landroid/net/wifi/WifiStateMachine;J)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$18800(Landroid/net/wifi/WifiStateMachine;)Landroid/net/LinkProperties;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$18900(Landroid/net/wifi/WifiStateMachine;Landroid/net/LinkProperties;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$19100(Landroid/net/wifi/WifiStateMachine;)Landroid/net/ConnectivityManager;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$19500(Landroid/net/wifi/WifiStateMachine;)Landroid/app/PendingIntent;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$19600(Landroid/net/wifi/WifiStateMachine;)I
    .locals 1
    .parameter "x0"
...
.method static synthetic access$19704(Landroid/net/wifi/WifiStateMachine;)I
    .locals 1
    .parameter "x0"
...
.method static synthetic access$20600(Landroid/net/wifi/WifiStateMachine;)Landroid/os/Message;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$20700(Landroid/net/wifi/WifiStateMachine;)Lcom/android/internal/util/AsyncChannel;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$20800(Landroid/net/wifi/WifiStateMachine;Landroid/net/wifi/WifiConfiguration;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$21302(Z)Z
    .locals 0
    .parameter "x0"
...
.method static synthetic access$21602(Z)Z
    .locals 0
    .parameter "x0"
...
.method static synthetic access$21700(Landroid/net/wifi/WifiStateMachine;Ljava/util/ArrayList;)Z
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$22802(Landroid/net/wifi/WifiStateMachine;Landroid/telephony/SignalStrength;)Landroid/telephony/SignalStrength;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$2500(Landroid/net/wifi/WifiStateMachine;Landroid/os/Message;II)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$2600(Landroid/net/wifi/WifiStateMachine;Landroid/os/Message;ILjava/lang/Object;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$3000(Landroid/net/wifi/WifiStateMachine;)I
    .locals 1
    .parameter "x0"
...
.method static synthetic access$3002(Landroid/net/wifi/WifiStateMachine;I)I
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$3300(Landroid/net/wifi/WifiStateMachine;Landroid/os/Message;I)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$3800(Landroid/net/wifi/WifiStateMachine;)Landroid/net/wifi/p2p/WifiP2pManager;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$3802(Landroid/net/wifi/WifiStateMachine;Landroid/net/wifi/p2p/WifiP2pManager;)Landroid/net/wifi/p2p/WifiP2pManager;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$4000(Landroid/net/wifi/WifiStateMachine;)Landroid/os/PowerManager$WakeLock;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$5400(Landroid/net/wifi/WifiStateMachine;Landroid/net/wifi/WifiConfiguration;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$5500(Landroid/net/wifi/WifiStateMachine;)Landroid/net/NetworkInfo;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$6300(Landroid/net/wifi/WifiStateMachine;)Landroid/os/Message;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$6900(Landroid/net/wifi/WifiStateMachine;)Ljava/lang/String;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$7200(Landroid/net/wifi/WifiStateMachine;)Landroid/net/wifi/SupplicantStateTracker;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$7300(Landroid/net/wifi/WifiStateMachine;)Landroid/net/wifi/WifiStateMachine$CwHandler;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$7302(Landroid/net/wifi/WifiStateMachine;Landroid/net/wifi/WifiStateMachine$CwHandler;)Landroid/net/wifi/WifiStateMachine$CwHandler;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$7402(Landroid/net/wifi/WifiStateMachine;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$7602(Landroid/net/wifi/WifiStateMachine;I)I
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$7702(Landroid/net/wifi/WifiStateMachine;I)I
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$7800(Landroid/net/wifi/WifiStateMachine;)Landroid/net/wifi/WifiInfo;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$900(Landroid/net/wifi/WifiStateMachine;)Landroid/os/PowerManager$WakeLock;
    .locals 1
    .parameter "x0"
...
.method private checkVzwWifiAggregation(Ljava/util/List;)V
    .locals 8
    .parameter
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    iget-object v6, p0, Landroid/net/wifi/WifiStateMachine;->mVzwWifiString:Ljava/lang/String;
    ...
    .line 3457
    .local v1, VzwWifiInConfFile:Z
    const/4 v2, 0x0

    .line 3458
    .local v2, VzwWifiInScanList:Z
    iput-boolean v7, p0, Landroid/net/wifi/WifiStateMachine;->mWifiAggregation:Z
    ...
    const-string v6, "VzwWifiInScanList is true"
    ...
    iput-boolean v5, p0, Landroid/net/wifi/WifiStateMachine;->mWifiAggregation:Z
...
.method private handleNetworkDisconnect()V
    ...
    .line 3805
    invoke-virtual {p0, v3}, Landroid/net/wifi/WifiStateMachine;->setCwRegisterState(Z)V
...
.method private handleSuccessfulIpConfiguration(Landroid/net/DhcpInfoInternal;)V
    ...
    iget-object v6, p1, Landroid/net/DhcpInfoInternal;->vendorInfo:Ljava/lang/String;

    invoke-virtual {v5, v6}, Landroid/net/wifi/WifiInfo;->setVendorInfo(Ljava/lang/String;)V
...
.method private sendVzwStatusNotification(I)I
    ...
    .line 9134
    .restart local v5       #sTitle:Ljava/lang/String;
    const-string v4, "Click to Connect to VerizonWiFi"
...
.method private setScanResults(Ljava/lang/String;)V
    ...
    .line 3439
    invoke-direct {p0, v4}, Landroid/net/wifi/WifiStateMachine;->checkVzwWifiAggregation(Ljava/util/List;)V
    ...
    iget-boolean v7, p0, Landroid/net/wifi/WifiStateMachine;->mWifiAggregation:Z
    ...
    const-string v8, "VzwStatus[Verizon AP detected but not connected]"
...
.method private updateApConfiguration(Landroid/net/wifi/WifiConfiguration;)V
    ...
    const-string v4, "mConfig.getWifiApProfile().SSID is null, give temp default SSID..."
...
.method private updateV6AddressesWithAnotherThread(Landroid/net/LinkProperties;)V
    ...
    invoke-direct {v1, p0, p1}, Landroid/net/wifi/WifiStateMachine$10;-><init>(Landroid/net/wifi/WifiStateMachine;Landroid/net/LinkProperties;)V
...
.method public getCustomizedSsid()Ljava/lang/String;
    ...
    .prologue
    .line 9052
    iget-boolean v2, p0, Landroid/net/wifi/WifiStateMachine;->mEnableImeiSsid:Z

    if-eqz v2, :cond_0

    .line 9053
    const-string/jumbo v2, "ro.gsm.imei"
