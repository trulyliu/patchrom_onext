...
.method static synthetic access$200(Lcom/android/internal/view/menu/ActionMenuPresenter;)Lcom/android/internal/view/menu/ActionMenuPresenter$OverFlowMenuListener;
    .locals 1
    .parameter "x0"
...
.method public enableActionLimit(Landroid/content/Context;)V
    ...
    const-string v3, "enableActionLimit = "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-boolean v3, p0, Lcom/android/internal/view/menu/ActionMenuPresenter;->enableActionLimit:Z
...
.method public initForMenu(Landroid/content/Context;Lcom/android/internal/view/menu/MenuBuilder;)V
    ...
    .line 119
    :cond_2
    iget v5, p0, Lcom/android/internal/view/menu/ActionMenuPresenter;->mWidthLimit:I
    ...
    .line 124
    iget-boolean v6, p0, Lcom/android/internal/view/menu/ActionMenuPresenter;->enableActionLimit:Z
    ...
    invoke-virtual {v6, v7, v11, v10}, Landroid/view/LayoutInflater;->inflate(ILandroid/view/ViewGroup;Z)Landroid/view/View;
    ...
    const-string v7, "action_bar_menu"
    ...
    invoke-virtual {v6, v2}, Lcom/android/internal/view/menu/OverflowMenuView;->setText(I)V
    ...
    iget-object v7, p0, Lcom/android/internal/view/menu/ActionMenuPresenter;->invokeOverflowMenu:Landroid/view/View$OnClickListener;
    ...
    .line 165
    :goto_3
    iput v5, p0, Lcom/android/internal/view/menu/ActionMenuPresenter;->mActionItemWidthLimit:I
    ...
    iput v6, p0, Lcom/android/internal/view/menu/ActionMenuPresenter;->mMinCellSize:I

    .line 170
    iput-object v11, p0, Lcom/android/internal/view/menu/ActionMenuPresenter;->mScrapActionButtonView:Landroid/view/View;
    ...
    const-string v7, "action_bar_menu not found"
    ...
    const-string v7, "overflowView id not found"
    ...
    .end local v4           #viewID:I
    :cond_6
    new-instance v6, Lcom/android/internal/view/menu/ActionMenuPresenter$OverflowMenuButton;

    iget-object v7, p0, Lcom/android/internal/view/menu/BaseMenuPresenter;->mSystemContext:Landroid/content/Context;

    invoke-direct {v6, p0, v7}, Lcom/android/internal/view/menu/ActionMenuPresenter$OverflowMenuButton;-><init>(Lcom/android/internal/view/menu/ActionMenuPresenter;Landroid/content/Context;)V
    ...
    .line 162
    :cond_7
    iput-object v11, p0, Lcom/android/internal/view/menu/ActionMenuPresenter;->mOverflowButton:Landroid/view/View;
...
.method public updateMenuView(Z)V
    ...
    .line 251
    iget-object v11, p0, Lcom/android/internal/view/menu/BaseMenuPresenter;->mMenu:Lcom/android/internal/view/menu/MenuBuilder;
    ...
    .line 279
    iget-boolean v11, p0, Lcom/android/internal/view/menu/ActionMenuPresenter;->enableActionLimit:Z
    ...
    iget-object v12, p0, Lcom/android/internal/view/menu/ActionMenuPresenter;->invokeOverflowMenu:Landroid/view/View$OnClickListener;
    ...
    invoke-virtual {v5, v11}, Lcom/android/internal/view/menu/ActionMenuView;->addView(Landroid/view/View;)V
    ...
    const-string v12, "icon_btn_menu_dark"
    ...
    check-cast v11, Lcom/android/internal/view/menu/OverflowMenuView;

    iget-object v12, p0, Lcom/android/internal/view/menu/BaseMenuPresenter;->mSystemContext:Landroid/content/Context;
    ...
    invoke-virtual {v11, v12}, Lcom/android/internal/view/menu/OverflowMenuView;->setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    check-cast v11, Lcom/android/internal/view/menu/ActionMenuView;

    iget-boolean v12, p0, Lcom/android/internal/view/menu/ActionMenuPresenter;->mReserveOverflow:Z

    invoke-virtual {v11, v12}, Lcom/android/internal/view/menu/ActionMenuView;->setOverflowReserved(Z)V
    ...
    .end local v1           #count:I
    :cond_a
    new-instance v11, Lcom/android/internal/view/menu/ActionMenuPresenter$OverflowMenuButton;

    iget-object v12, p0, Lcom/android/internal/view/menu/BaseMenuPresenter;->mSystemContext:Landroid/content/Context;

    invoke-direct {v11, p0, v12}, Lcom/android/internal/view/menu/ActionMenuPresenter$OverflowMenuButton;-><init>(Lcom/android/internal/view/menu/ActionMenuPresenter;Landroid/content/Context;)V
    ...
    .line 326
    .restart local v4       #lparams:Landroid/view/ViewGroup$LayoutParams;
    ...
    :cond_b
    const-string v11, "HTCActionBar"

    const-string v12, "icon_btn_menu_dark not found"
    ...
    invoke-virtual {v5, v11, v12}, Lcom/android/internal/view/menu/ActionMenuView;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    iget-object v12, p0, Lcom/android/internal/view/menu/BaseMenuPresenter;->mMenuView:Lcom/android/internal/view/menu/MenuView;
    ...
    iget-object v12, p0, Lcom/android/internal/view/menu/ActionMenuPresenter;->mOverflowButton:Landroid/view/View;
