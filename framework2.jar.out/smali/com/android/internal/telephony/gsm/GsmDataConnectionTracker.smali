...
.method private HtcCleanupDC(Lcom/android/internal/telephony/DataConnectionAc;Lcom/android/internal/telephony/ApnContext;)V
    ...
    .prologue
    .line 3385
    invoke-virtual/range {p1 .. p1}, Lcom/android/internal/telephony/DataConnectionAc;->getApnSettingSync()Lcom/android/internal/telephony/ApnSetting;

    move-result-object v4

    .line 3386
    .local v4, apnSetting:Lcom/android/internal/telephony/ApnSetting;
    if-nez v4, :cond_0

    .line 3388
    invoke-direct/range {p0 .. p1}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->getByReferredAC(Lcom/android/internal/telephony/DataConnectionAc;)Lcom/android/internal/telephony/ApnSetting;
    ...
    const-string v14, "HtcCleanupDC: got apnsetting="
    ...
    .line 3405
    :cond_0
    iget-object v13, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->mSwitchApnRecord:Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker$HtcSwitchApnRecord;

    iget-object v13, v13, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker$HtcSwitchApnRecord;->switchOffACs:Ljava/util/ArrayList;
    ...
    .line 3406
    const-string v13, "HtcCleanupDC(): switchOffACs is not empty "
    ...
    .line 3408
    .local v10, tmp:Lcom/android/internal/telephony/ApnContext;
    new-instance v13, Ljava/lang/StringBuilder;

    invoke-direct {v13}, Ljava/lang/StringBuilder;-><init>()V

    const-string v14, "switchOffACs="
    ...
    .line 3410
    .end local v10           #tmp:Lcom/android/internal/telephony/ApnContext;
    :cond_1
    iget-object v13, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->mSwitchApnRecord:Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker$HtcSwitchApnRecord;
    ...
    .line 3412
    .restart local v10       #tmp:Lcom/android/internal/telephony/ApnContext;
    new-instance v13, Ljava/lang/StringBuilder;

    invoke-direct {v13}, Ljava/lang/StringBuilder;-><init>()V

    const-string v14, "after clear, switchOffACs="
    ...
    .end local v10           #tmp:Lcom/android/internal/telephony/ApnContext;
    :cond_2
    iget-object v6, v4, Lcom/android/internal/telephony/ApnSetting;->types:[Ljava/lang/String;
    ...
    iget-object v13, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->mApnContexts:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 3421
    .local v11, tmpac:Lcom/android/internal/telephony/ApnContext;
    if-nez v11, :cond_4
    ...
    const-string v14, "HtcCleanupDC WARNING: got null ac from dcac\'s types[], type="
    ...
    .line 3425
    :cond_4
    invoke-virtual {v11}, Lcom/android/internal/telephony/ApnContext;->getDataConnectionAc()Lcom/android/internal/telephony/DataConnectionAc;
    ...
    .line 3430
    .end local v11           #tmpac:Lcom/android/internal/telephony/ApnContext;
    .end local v12           #type:Ljava/lang/String;
    :cond_5
    const/4 v1, 0x0

    .line 3432
    .local v1, ac:Lcom/android/internal/telephony/ApnContext;
    iget-object v13, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->mSwitchApnRecord:Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker$HtcSwitchApnRecord;
    ...
    .line 3433
    invoke-virtual/range {p1 .. p1}, Lcom/android/internal/telephony/DataConnectionAc;->getApnListSync()Ljava/util/Collection;
    ...
    .line 3439
    const-string v13, "mSwitchApnRecord.switchOffACs is empty. Should not happen"
    ...
    .end local v1           #ac:Lcom/android/internal/telephony/ApnContext;
    check-cast v1, Lcom/android/internal/telephony/ApnContext;

    .line 3449
    .restart local v1       #ac:Lcom/android/internal/telephony/ApnContext;
    iget-object v13, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->mSwitchApnRecord:Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker$HtcSwitchApnRecord;

    move-object/from16 v0, p2

    iput-object v0, v13, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker$HtcSwitchApnRecord;->pendingAC:Lcom/android/internal/telephony/ApnContext;

    .line 3451
    iget-object v13, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->mSwitchApnRecord:Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker$HtcSwitchApnRecord;

    invoke-virtual {v13}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker$HtcSwitchApnRecord;->dumpSwitchApnRecord()V

    .line 3453
    const-string v13, "apnSwitched"
    ...
    .line 3456
    .local v3, apnList:Ljava/util/Collection;,"Ljava/util/Collection<Lcom/android/internal/telephony/ApnContext;>;"
    ...
    invoke-virtual {v2, v13}, Lcom/android/internal/telephony/ApnContext;->setReason(Ljava/lang/String;)V
    ...
    iget-object v13, v0, Lcom/android/internal/telephony/DataConnectionAc;->dataConnection:Lcom/android/internal/telephony/DataConnection;

    invoke-virtual {v13}, Lcom/android/internal/telephony/DataConnection;->resetRefCount()V

    .line 3462
    const v13, 0x4200f

    invoke-virtual {p0, v13, v1}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    .line 3465
    const-string v13, "!!! ac.dc is null. It should not happen"
    ...
    invoke-virtual {v13, v14, v9}, Lcom/android/internal/telephony/DataConnection;->tearDownAll(Ljava/lang/String;Landroid/os/Message;)V
...
.method private setupData(Lcom/android/internal/telephony/ApnContext;)Z
    ...
    const-string v10, "setupData: apnContext="
    ...
    .line 2092
    .local v4, olddc:Lcom/android/internal/telephony/gsm/GsmDataConnection;
    invoke-virtual {p1}, Lcom/android/internal/telephony/ApnContext;->getApnType()Ljava/lang/String;

    move-result-object v7

    invoke-virtual {p0, v7}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->getApnProfileID(Ljava/lang/String;)I
    ...
    .line 2103
    invoke-virtual {p1, v11}, Lcom/android/internal/telephony/ApnContext;->setApnSetting(Lcom/android/internal/telephony/ApnSetting;)V

    .line 2104
    invoke-virtual {p1, v11}, Lcom/android/internal/telephony/ApnContext;->setDataConnection(Lcom/android/internal/telephony/DataConnection;)V

    .line 2105
    invoke-virtual {p1, v11}, Lcom/android/internal/telephony/ApnContext;->setDataConnectionAc(Lcom/android/internal/telephony/DataConnectionAc;)V
    ...
    .line 2138
    const-string v7, "setupData: No ready GsmDataConnection found!"
    ...
    .line 2176
    const-string v7, "setupData: apn from DC is null. DC is under disconnecting. State not sync yet."
    ...
    invoke-direct {p0, v1, v7, v10}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->configureRetry(Lcom/android/internal/telephony/DataConnection;ZI)V
    ...
    .line 2216
    const-string v7, "setupData: data reconnection pending"
    ...
    .line 2223
    :cond_d
    iget-object v7, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->mSwitchApnRecord:Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker$HtcSwitchApnRecord;

    invoke-virtual {v7}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker$HtcSwitchApnRecord;->dumpSwitchApnRecord()V

    .line 2243
    iget v7, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->pdpLimitSize:I
    ...
    .line 2248
    const-string v7, "ril.pdn.profile"
    ...
    .line 2259
    const-string v7, "setupData: initing!"
